...
function comment_form( $args = array(), $post_id = null ) {
	...
	$defaults = array(
		...
		'must_log_in'          => do_shortcode('[fbl_login_button redirect="" hide_if_logged="" ]')/*'<p>You must be logged in to post a comment.</p><p class="must-log-in">'*/ . sprintf(
		                              /* translators: %s: login URL */
		                              __(''), /*You must be logged in to post a comment.*/
		                              wp_login_url( apply_filters( 'the_permalink', get_permalink( $post_id ) ) )
		                          ) . '</p>',
									 /* <a href="%s"><img src="http://www.uobchinese.co.uk/images/fblogin.png" width="190px"/></a> */
