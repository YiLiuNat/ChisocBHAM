...
function amadeus_footer_credits() {
	echo '<a href="' . esc_url( __( 'http://uobchinese.co.uk', 'amadeus' ) ) . '" rel="nofollow">';
	/* translators: WordPress */
	printf( __( '<a href="http://uobchinese.co.uk" rel="nofollow">Chinese Society</a>', ' ' ), 'Chinese Society' );
	echo '</a>';
	echo '<span class="sep"> | </span>';
	/* translators: 1 - WordPress link, 2 - Theme name */
	printf( __( '<a href="http://uobchinese.co.uk" rel="nofollow">University of Birmingham</a>', ' ' ), ' ', '<a href="http://uobchinese.co.uk" rel="nofollow">Chinese Society</a>' );
}
